...
import {get_Shipped} from "../../actions/shippedAction.js";
   ...
   // console.log(this.props.tBarcodeArray);
    const options = {
      ...
      sizePerPageList: [
        ...
        {
          text: "All",
          value: this.props.shippedArray.length
        }
        ...
        <React.Fragment>
          <section className="content-header">
            ...
            <ol className="breadcrumb">
              ...
              <li className="active"> Shipped Form </li>
            </ol>
          </section>
            ...
            >
              <div className="box">
                <div className="box-header with-border">
                  <h3 className="box-title">Shipped</h3>
...
const mapsToprops = state => {
  return {
    shippedArray: state.shippedReducer.shippedArray
  };
};
