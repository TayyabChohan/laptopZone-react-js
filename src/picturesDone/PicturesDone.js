...
import {  } from '../actions/pictureAction.js';

const action = {
  totalBarcode
};

class PicturesDone extends Component {
  constructor(props) {
   ...
   // console.log(this.props.tBarcodeArray);
    const options = {
      ...
      sizePerPageList: [
        ...
        {
          text: "All",
          value: this.props.tBarcodeArray.length
        }
        ...
        <React.Fragment>
          <section className="content-header">
            ...
            <ol className="breadcrumb">
              ...
              <li className="active"> Pictures Done </li>
            </ol>
          </section>
            ...
            <div className="col-sm-12" style={{ paddingLeft: "0%", paddingRight: "0%" }} >
              <div className="box">
                <div className="box-header with-border">
                  <h3 className="box-title"> Pictures </h3>
...
const mapsToprops = state => {
  return {
    tBarcodeArray: state.totalBarcodeReducer.tBarcodeArray
  };
};
