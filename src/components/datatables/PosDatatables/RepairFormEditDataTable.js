...
const onAfterSaveCell = (row, cellName, cellValue) => {
  if (cellName == 'COST_PRICE') {
    ...
    that.props.change_cost_price_repaire_edit(data)
  }
  if (cellName == 'ADVANCE_PAYMENT') {
    ...
    that.props.change_advance_payment_repaire_edit(data)
  }
...
class LineTypes extends Component {
  ...
  componentDidUpdate (prevProps, prevState) {
    if (
      ...
      that.props.change_line_type_repaire_edit(data)
    }
  }
  render () {
    const Line_types = [
...
var that = ''
class RepairFormEditDataTable extends Component {
  constructor (props) {
    super(props)
    this.state = {
      button_status: false
  ...
  onClickDelete = (cell, row) => {
    ...
    this.props.delete_pos_barcode_repaire_edit(data)
  }
  ...
  render () {
    ...
    const options = {
      ...
      sizePerPageList: [
        ...
        {
          text: 'All',
          value: this.props.pos_repair_barcode_detail_edit.length
        }
...
export default RepairFormEditDataTable
