  ...
  Delete = (cell, row) => {
    ...
    new Promise(function(resolve, reject) {
      ...
      .then(result => {
        $.LoadingOverlay("hide");
        if (result.delete) {
          var barcodes = that.state.auditItems;
...
class ListedItemsAudit extends Component {
  constructor(props) {
    super(props);
    that = this;
  ...
  searchAudit = () => {
    ...
    let insertUrl =
      this.state.baseUrl +
      "/laptopzone/reactcontroller/c_itemsAudit/searchAudit";
    new Promise(function(resolve, reject) {
      $.ajax({
        url: insertUrl,
        dataType: "json",
      ...
      .then(result => {
        ...
        if (result.found) {
          this.setState({
            auditItems: result.allAuditData,
  ...
  render() {
    const { auditItems, date } = this.state;
    const options = {
                ...
                <div className="box-body">
                  <div className="col-md-12">
                    ...
                    <div className="col-sm-2 pull-left">
                      <Link to="/dekitItemsAudit" style={{ color: "white" }}>
                        <button className="btn btn-success">
                          Dekit Listed Items Audit
                        </button>
                      </Link>
                    </div>
                  </div>
                ...
                <div className="box-body">
                  <div className="col-md-12">
                    ...
                    >
                      ...
                      <TableHeaderColumn dataField="BARCODE_NO" width="6.7%">
                        Barcode
                      </TableHeaderColumn>
...
export default ListedItemsAudit;
